  ...
  return (
    <div className="container mx-auto max-w-6xl p-8 2xl:px-0">
      ...
      <div className={"flex justify-center items-center h-screen"}>
        <div className={"w-2/6"}>
        <Image src={dali} />
          <p className={"flex justify-center items-center text-2xl pb-5 font-bold"}>You are a bit early, little bun.</p>
          <p className={"flex justify-center pb-5 text-center"}>We are still under construction. But no worries, if you don't want to miss a fart, you can follow what we do and join our Discord!</p>
